...
describe "Associations — Song and Artist:" do
  ...
  context "Song" do
    ...
    describe "#initialize" do
      it "invokes #set_artist instead of simply assigning to an @artist instance variable to ensure that associations are created upon initialization" do
        expect_any_instance_of(Song).to receive(:set_artist).with(artist)
